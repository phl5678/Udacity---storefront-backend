...
var OrderStore = /** @class */ (function () {
     ...
     */
    OrderStore.prototype.index4User = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = 'SELECT a.id, b.product_id, c.name, c.price, b.quantity, a.user_id, a.status FROM orders as a LEFT JOIN order_products as b ON a.id=b.order_id LEFT JOIN products as c ON c.id = b.product_id WHERE a.user_id=($1)';
                        return [4 /*yield*/, database_1["default"].connect()];
                    case 1:
                        conn = _a.sent();
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Could not find order for user ".concat(userId, ". Error: ").concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
     ...
     * @returns a promise with array of custom order info object containing order id, product id, name, price, quantity, user id, and order status.
     */
    OrderStore.prototype.index4UserByStatus = function (userId, status) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = 'SELECT a.id, b.product_id, c.name,c.price, b.quantity, a.user_id, a.status FROM orders as a LEFT JOIN order_products as b ON a.id=b.order_id LEFT JOIN products as c ON c.id = b.product_id WHERE a.user_id=($1) and status=($2)';
                        return [4 /*yield*/, database_1["default"].connect()];
                    case 1:
                        conn = _a.sent();
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not find order status ".concat(status, " for user ").concat(userId, ". Error: ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not add product ".concat(productId, " to order ").concat(orderId, ". Error: ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
     ...
     */
    OrderStore.prototype.showOrder = function (orderId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = 'SELECT * FROM order_products LEFT JOIN products ON products.id=order_products.product_id WHERE order_id=($1)';
                        return [4 /*yield*/, database_1["default"].connect()];
                    case 1:
                        conn = _a.sent();
                    ...
                    case 3:
                        err_5 = _a.sent();
                        throw new Error("Could not get products for order ".concat(orderId, ". Error: ").concat(err_5));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_6 = _a.sent();
                        throw new Error("Could not add new order for user ".concat(o.user_id, ". Error: ").concat(err_6));
                    case 4: return [2 /*return*/];
                }
            });
        });
