...
var ProductStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Could not get products in ".concat(category, " category. Error: ").concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not add new product ".concat(p.name, ". Error: ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
     ...
     */
    ProductStore.prototype.createMultiple = function (products) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, values, i, product, conn, result, err_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        ...
                        for (i = 0; i < products.length; i++) {
                            ...
                            sql += "($".concat(3 * i + 1, ", $").concat(3 * i + 2, ", $").concat(3 * i + 3, ")");
                        }
                        sql += ' RETURNING *';
                        return [4 /*yield*/, database_1["default"].connect()];
                    case 1:
                    ...
                    case 3:
                        err_5 = _a.sent();
                        throw new Error("Could not add ".concat(products.length, " new products. Error: ").concat(err_5));
                    case 4: return [2 /*return*/];
                }
            });
        });
